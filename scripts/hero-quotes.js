 ...
 *
 * Timings:
 * - DISPLAY_MS = 10000 (10s par citation)
 * - TRANSITION_MS = 500 (fondu)
 * A11y:
 * - Section focusable (tabindex=0)
 * - Navigation clavier ←/→ (ou A/Q clavier FR)
 * - aria-live="polite" sur la citation active
 */
(function () {
  ...
  // API publique — monte la section dans le conteneur fourni
